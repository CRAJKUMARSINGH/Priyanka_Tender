            ...
            <table class="main-table">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" style="width: 25%;">Name of Bidders</th>
                        <th rowspan="2" style="width: 12%;">Earnest Money<br>(Rs.)</th>
                        <th colspan="2" style="width: 25%;">Rate Quoted</th>
                        <th rowspan="2" style="width: 15%;">Tendered Amount<br>(Rs.)</th>
        ...
        for i, bidder in enumerate(sorted_bidders):
            ...
            html_content += f"""
                    <tr class="{row_class}">
                        ...
                        <td class="amount">{bidder.get('earnest_money', earnest_money)}</td>
